...
**Tweet2speech** is a simple tool for remote participation in manifestations and public events, which gives voice to whom are not physically present in a place.  The application uses the Android’s text to speech engine to read *tweets* containing a specific *hashtag*, previously defined by the user in the application.
